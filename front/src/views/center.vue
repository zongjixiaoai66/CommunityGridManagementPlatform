  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='人口状态' prop="renkouzhuangtaiTypes">
                 <el-select v-model="ruleForm.renkouzhuangtaiTypes"  placeholder='请选择人口状态'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='小区' prop="xiaoquTypes">
                 <el-select v-model="ruleForm.xiaoquTypes"  placeholder='请选择小区'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='身体状况' prop="shentiTypes">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='单位' prop="danweileixingTypes">
                 <el-select v-model="ruleForm.danweileixingTypes"  placeholder='请选择单位'>
                     <el-option
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.renkouzhuangtaiTypes)&& 'yonghu'==this.flag){
                             this.$message.error('人口状态不能为空');
                             return
                         }

                         if((!this.ruleForm.xiaoquTypes)&& 'yonghu'==this.flag){
                             this.$message.error('小区不能为空');
                             return
                         }

                         if((!this.ruleForm.shentiTypes)&& 'yonghu'==this.flag){
                             this.$message.error('身体状况不能为空');
                             return
                         }

                         if((!this.ruleForm.danweileixingTypes)&& 'yonghu'==this.flag){
