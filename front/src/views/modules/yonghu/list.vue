        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '人口状态' : ''">
                        <el-select v-model="searchForm.renkouzhuangtaiTypes" placeholder="请选择人口状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in renkouzhuangtaiTypesSelectSearch"
                               v-bind:key="index"
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '小区' : ''">
                        <el-select v-model="searchForm.xiaoquTypes" placeholder="请选择小区">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in xiaoquTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequwanggehuaguanlipingtai/upload/yonghuMuBan.xls"
                        >批量导入用户数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="renkouzhuangtaiTypes"
                                      header-align="center"
                                      label="人口状态">
                        <template slot-scope="scope">
                            {{scope.row.renkouzhuangtaiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xiaoquTypes"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="danweileixingTypes"
                                      header-align="center"
                                      label="单位">
                        <template slot-scope="scope">
                            {{scope.row.danweileixingValue}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //级联表下拉框搜索条件
    //当前表下拉框搜索条件
              renkouzhuangtaiTypesSelectSearch : [],
              xiaoquTypesSelectSearch : [],
            ...
            form:{
                ...
                sexTypes : null,
                age : null,
                renkouzhuangtaiTypes : null,
                xiaoquTypes : null,
                shentiTypes : null,
                danweileixingTypes : null,
                yonghuEmail : null,
                createTime : null,
            },
            dataList: [],
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '性别': "sexValue",
                     '年龄': "age",
                     '人口状态': "renkouzhuangtaiValue",
                     '小区': "xiaoquValue",
                     '身体状况': "shentiValue",
                     '单位': "danweileixingValue",
                     '用户邮箱': "yonghuEmail",
            },
        ...
        methods: {
            chartDialog() {
                ...
                this.$nextTick(()=>{
                    ...
                    let params = {
                        tableName: "yonghu",
                        groupColumn: "renkouzhuangtai_types",
                    }
                    this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.renkouzhuangtaiTypes!= '' && this.searchForm.renkouzhuangtaiTypes!= undefined) {
                    params['renkouzhuangtaiTypes'] = this.searchForm.renkouzhuangtaiTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=renkouzhuangtai_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.renkouzhuangtaiTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=xiaoqu_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.xiaoquTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
