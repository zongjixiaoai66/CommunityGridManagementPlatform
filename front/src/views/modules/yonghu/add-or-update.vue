        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="人口状态" prop="renkouzhuangtaiTypes">
                        <el-select v-model="ruleForm.renkouzhuangtaiTypes" :disabled="ro.renkouzhuangtaiTypes" placeholder="请选择人口状态">
                            <el-option
                                v-for="(item,index) in renkouzhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="人口状态" prop="renkouzhuangtaiValue">
                        <el-input v-model="ruleForm.renkouzhuangtaiValue"
                            placeholder="人口状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="小区" prop="xiaoquTypes">
                        <el-select v-model="ruleForm.xiaoquTypes" :disabled="ro.xiaoquTypes" placeholder="请选择小区">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="小区" prop="xiaoquValue">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身体状况" prop="shentiTypes">
                        <el-select v-model="ruleForm.shentiTypes" :disabled="ro.shentiTypes" placeholder="请选择身体状况">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="单位" prop="danweileixingTypes">
                        <el-select v-model="ruleForm.danweileixingTypes" :disabled="ro.danweileixingTypes" placeholder="请选择单位">
                            <el-option
                                v-for="(item,index) in danweileixingTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="单位" prop="danweileixingValue">
                        <el-input v-model="ruleForm.danweileixingValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    sexTypes: false,
                    age: false,
                    renkouzhuangtaiTypes: false,
                    xiaoquTypes: false,
                    shentiTypes: false,
                    danweileixingTypes: false,
                    yonghuEmail: false,
                },
                ruleForm: {
                    username: '',
                ...
                sexTypesOptions : [],
                renkouzhuangtaiTypesOptions : [],
                xiaoquTypesOptions : [],
                shentiTypesOptions : [],
                danweileixingTypesOptions : [],
                rules: {
                   username: [
                   ...
                   renkouzhuangtaiTypes: [
                              { required: true, message: '人口状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renkouzhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renkouzhuangtaiTypesOptions = data.data.list;
                    }
                });
                this.$http({
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=danweileixing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.danweileixingTypesOptions = data.data.list;
                    }
                });
