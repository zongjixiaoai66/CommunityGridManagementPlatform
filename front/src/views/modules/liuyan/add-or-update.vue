            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="年龄" prop="age">
                        <el-input v-model="yonghuForm.age"
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="人口状态" prop="renkouzhuangtaiValue">
                        <el-input v-model="yonghuForm.renkouzhuangtaiValue"
                                  placeholder="人口状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小区" prop="xiaoquValue">
                        <el-input v-model="yonghuForm.xiaoquValue"
                                  placeholder="小区" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="身体状况" prop="shentiValue">
                        <el-input v-model="yonghuForm.shentiValue"
                                  placeholder="身体状况" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="单位" prop="danweileixingValue">
                        <el-input v-model="yonghuForm.danweileixingValue"
