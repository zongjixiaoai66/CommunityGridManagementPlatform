                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequwanggehuaguanlipingtai/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '用户头像': 'yonghuPhoto',
                     '年龄': 'age',
                     '人口状态': 'renkouzhuangtaiTypes',
                     '小区': 'xiaoquTypes',
                     '身体状况': 'shentiTypes',
                     '单位': 'danweileixingTypes',
                     '用户邮箱': 'yonghuEmail',
                     '学生名': 'username',
                     '角色': 'role',
                     '新增时间': 'addtime',
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.age = el.age;
                            forum.renkouzhuangtaiTypes = el.renkouzhuangtaiTypes;
                            forum.xiaoquTypes = el.xiaoquTypes;
                            forum.shentiTypes = el.shentiTypes;
                            forum.danweileixingTypes = el.danweileixingTypes;
