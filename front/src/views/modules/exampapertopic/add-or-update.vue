			...
			<el-row>
				<el-col :span="12" v-if="sessionTable !='exampaper' ">
					<el-form-item class="input" v-if="type!='info'" label="问卷调查名称" prop="exampaperName">
						<el-input v-model="exampaperForm.exampaperName" placeholder="问卷调查名称" clearable readonly>
						</el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="问卷调查名称" prop="exampaperName">
							<el-input v-model="ruleForm.exampaperName" placeholder="问卷调查名称" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='exampaper' ">
					<el-form-item class="input" v-if="type!='info'" label="调查时长(分钟)" prop="exampaperDate">
						<el-input v-model="exampaperForm.exampaperDate" placeholder="调查时长(分钟)" clearable readonly>
						</el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="调查时长(分钟)" prop="exampaperDate">
							<el-input v-model="ruleForm.exampaperDate" placeholder="调查时长(分钟)" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='exampaper' ">
					<el-form-item class="input" v-if="type!='info'" label="问卷调查总分数" prop="exampaperMyscore">
						<el-input v-model="exampaperForm.exampaperMyscore" placeholder="问卷调查总分数" clearable readonly>
						</el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="问卷调查总分数" prop="exampaperMyscore">
							<el-input v-model="ruleForm.exampaperMyscore" placeholder="问卷调查总分数" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
