		...
		<div v-if="showFlag">
			<el-form :inline="true" :model="searchForm" class="form-content">
				<el-row :gutter="20" class="slt"
					...
					<el-form-item>
						<el-input prefix-icon="el-icon-search" v-model="searchForm.exampaperName" placeholder="问卷调查名称"
							clearable></el-input>
					</el-form-item>
...
<!--							<el-input style="width: 320px;" type="number" min="0" :max="panXisting" placeholder="数量"
					...
					<el-col :span="zujuanTypes==1?6:24" style="margin-bottom: 10px;">
						...
						<el-tag style="float: right;" size="small">问卷调查总分:<span style="font-size: 20px;">{{exampapertopicNumber}}</span></el-tag>
					</el-col>
				</el-row>
			</el-form>
			<div class="table-content">
				<el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
						prop="exampaperName" header-align="center" label="问卷调查名称">
