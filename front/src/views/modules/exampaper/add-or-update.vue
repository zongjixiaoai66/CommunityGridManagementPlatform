    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="问卷调查名称" prop="exampaperName">
                        <el-input v-model="ruleForm.exampaperName"
                                  placeholder="问卷调查名称" clearable :readonly="ro.exampaperName"></el-input>
                    </el-form-item>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="调查时长(分钟)" prop="exampaperDate">
                        <el-input v-model="ruleForm.exampaperDate"
                                  placeholder="调查时长(分钟)" clearable :readonly="ro.exampaperDate"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="问卷调查总分数" prop="exampaperMyscore">
                        <el-input v-model="ruleForm.exampaperMyscore"
                                  placeholder="问卷调查总分数" clearable :readonly="ro.exampaperMyscore"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="问卷调查状态" prop="exampaperTypes">
                        <el-select v-model="ruleForm.exampaperTypes" :disabled="ro.exampaperTypes"
                                   placeholder="请选择问卷调查状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="问卷调查状态" prop="exampaperValue">
                            <el-input v-model="ruleForm.exampaperValue"
                                      placeholder="问卷调查状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    exampaperName: [
                        {required: true, message: '问卷调查名称不能为空', trigger: 'blur'},
                    ],
                    exampaperDate: [
                        {required: true, message: '调查时长(分钟)不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
                    ...
                    exampaperMyscore: [
                        {required: true, message: '问卷调查总分数不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
                    ...
                    exampaperTypes: [
                        {required: true, message: '问卷调查状态不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
