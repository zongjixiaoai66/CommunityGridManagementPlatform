        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '问卷调查名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.exampaperName" placeholder="问卷调查名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '问卷调查状态' : ''">
                        <el-select v-model="searchForm.exampaperTypes" placeholder="请选择问卷调查状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequwanggehuaguanlipingtai/upload/exampaperMuBan.xls"
                        >批量导入问卷调查表数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('exampaper','导入导出')"
...
<!--                            <el-button v-if="isAuth('exampaper','调查') && scope.row.exampaperTypes==1" type="primary" icon="el-icon-edit" size="mini" @click="saveExamrecord(scope.row.id)">{{ contents.tableBtnFont == 1?'调查':'' }}</el-button>-->
...
<!--                            <el-button v-if="isAuth('exampaper','添加考题')" type="primary" size="mini" @click="chartDialog(scope.row.id)">调查排名</el-button>-->
        ...
        data() {
            return {
                ...
                json_fields: {
                    //级联表字段
                    //本表字段
                    '问卷调查名称': "exampaperName",
                    '调查时长(分钟)': "exampaperDate",
                    '问卷调查总分数': "exampaperMyscore",
                    '科目': "kemuTypes",
                    '单选题数量': "danNum",
                    '单选题每题分数': "danFen",
                    '多选题数量': "duoNum",
