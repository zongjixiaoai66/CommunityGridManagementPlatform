...
//                            yonghuEntity.setAge(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            yonghuEntity.setRenkouzhuangtaiTypes(Integer.valueOf(data.get(0)));   //人口状态 要改的
//                            yonghuEntity.setXiaoquTypes(Integer.valueOf(data.get(0)));   //小区 要改的
//                            yonghuEntity.setShentiTypes(Integer.valueOf(data.get(0)));   //身体状况 要改的
//                            yonghuEntity.setDanweileixingTypes(Integer.valueOf(data.get(0)));   //单位 要改的
