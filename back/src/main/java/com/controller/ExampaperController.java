                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ExampaperEntity exampaperEntity = new ExampaperEntity();
//                            exampaperEntity.setExampaperName(data.get(0));                    //问卷调查名称 要改的
//                            exampaperEntity.setExampaperDate(Integer.valueOf(data.get(0)));   //调查时长(分钟) 要改的
//                            exampaperEntity.setExampaperMyscore(Integer.valueOf(data.get(0)));   //问卷调查总分数 要改的
//                            exampaperEntity.setKemuTypes(Integer.valueOf(data.get(0)));   //科目 要改的
//                            exampaperEntity.setExampaperTypes(Integer.valueOf(data.get(0)));   //问卷调查状态 要改的
