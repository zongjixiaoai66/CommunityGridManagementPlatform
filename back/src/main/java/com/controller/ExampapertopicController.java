...
//                            exampapertopicEntity.setExampaperId(Integer.valueOf(data.get(0)));   //问卷调查 要改的
...
//        }
    ...
    */
    ...
    public R submitQuestions(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        examrecordEntity.setExampaperId(exampaperId);//问卷调查id
        examrecordEntity.setYonghuId(yonghuId);//调查用户
