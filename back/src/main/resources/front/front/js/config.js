...
var indexNav = [
    ...
    {
        name: '商业门店',
        url: './pages/shangyemendian/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequwanggehuaguanlipingtai/admin/dist/index.html#/login";
